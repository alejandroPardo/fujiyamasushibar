                ...
                <ul>
                    ...
                    <li><a href="portfolio-4-columns.html" class="active">Portfolio</a>
          				<ul>
                        	...
                        	<li><a href="portfolio-2-columns.html" class="active">2 Columns</a></li>
...
<section id="pagetitle">
	<div class="pagetitle_inner wrapperoverlay">
		<h2><strong>Portfolio</strong><span class="tagline">What we've done so far</h2>
    </div>
</section>
        	...
        	<div id="masonry" class="portfolio-entries columns2 clearfix">
            	<div class="masonry_item portfolio-entry post motion">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_01.jpg" alt="Work 01"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Nullam id dolor</strong></a></h5>
                ...
                <div class="masonry_item portfolio-entry post print">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_02.jpg" alt="Work 02"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Duo dolores</strong></a></h5>
                ...
                <div class="masonry_item portfolio-entry post print">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_03.jpg" alt="Work 03"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Takimata sanctus</strong></a></h5>
                        <span class="portfolio-categories">Print</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post web">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_04.jpg" alt="Work 04"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Lorem ipsum</strong></a></h5>
                ...
                <div class="masonry_item portfolio-entry post motion">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_05.jpg" alt="Work 05"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Kasd gubergren</strong></a></h5>
                        <span class="portfolio-categories">Motion</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post web">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_06.jpg" alt="Work 06"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Accusam et justo</strong></a></h5>
                        <span class="portfolio-categories">Web</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post print">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_07.jpg" alt="Work 07"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Eirmod tempor</strong></a></h5>
                        <span class="portfolio-categories">Print</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post web">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_08.jpg" alt="Work 08"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Invidunt</strong></a></h5>
                        <span class="portfolio-categories">Web</span>
                    </div>
                </div>
                ...
                <div class="masonry_item portfolio-entry post motion">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_09.jpg" alt="Work 09"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Magna aliquyam</strong></a></h5>
                        <span class="portfolio-categories">Motion</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post web">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_10.jpg" alt="Work 10"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Molestie</strong></a></h5>
                        <span class="portfolio-categories">Web</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post print">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_11.jpg" alt="Work 11"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Praesent luptatum</strong></a></h5>
                        <span class="portfolio-categories">Print</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post web">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html"><img src="files/images/portfolio/thumb-work_12.jpg" alt="Work 12"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html"><strong>Facilisi</strong></a></h5>
                        <span class="portfolio-categories">Web</span>
                    </div>
                </div>
            </div><!-- END #masonry -->	
