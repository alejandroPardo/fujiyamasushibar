...
<section id="pagetitle">
	<div class="pagetitle_inner wrapperoverlay">
		<h2><strong>About Us</strong><span class="tagline">We are Iris</span></h2>
    </div>
</section>
...
<section id="main">
    <div class="main_inner wrapper clearfix">
        ...
        <article>
            ...
            <h2 class="page-description"><i>Hello, I am Iris.  A Clean, Minimal & Responsive Portfolio/Blog Theme.  You can change your background-imag easily through CSS.</i></h2>
