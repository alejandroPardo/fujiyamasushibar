                ...
                <ul>
                    ...
                    <li><a href="portfolio-4-columns.html"  class="active">Portfolio</a>
          				<ul>
                            ...
                            <li><a href="portfolio-ajax.html" class="active">Portfolio (Ajax)</a></li>
...
<section id="pagetitle">
	<div class="pagetitle_inner wrapperoverlay">
		<h2><strong>Portfolio</strong><span class="tagline">Ajax loads the project dynamically</h2>
    </div>
</section>
        ...
        <article class="seperator">
        	...
        	<div id="masonry" class="portfolio-entries columns4 clearfix">
                ...
                <div class="masonry_item portfolio-entry post motion">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html" class="loadcontent" rel="magna-aliguyam"><img src="files/images/portfolio/thumb-work_09.jpg" alt="Work 09"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html" class="loadcontent" rel="magna-aliguyam"><strong>Magna aliquyam</strong></a></h5>
                        <span class="portfolio-categories">Motion</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post web">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html" class="loadcontent" rel="molestie"><img src="files/images/portfolio/thumb-work_10.jpg" alt="Work 10"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html" class="loadcontent" rel="molestie"><strong>Molestie</strong></a></h5>
                        <span class="portfolio-categories">Web</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post print">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html" class="loadcontent" rel="praesent-luptatum"><img src="files/images/portfolio/thumb-work_11.jpg" alt="Work 11"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html" class="loadcontent" rel="praesent-luptatum"><strong>Praesent luptatum</strong></a></h5>
                        <span class="portfolio-categories">Print</span>
                    </div>
              	</div>
                ...
                <div class="masonry_item portfolio-entry post web">
                    <div class="imgoverlay">
                        <a href="portfolio-single.html" class="loadcontent" rel="facilisi"><img src="files/images/portfolio/thumb-work_12.jpg" alt="Work 12"/></a>
                    </div>
                    <div class="portfolio-meta">
                    	<h5><a href="portfolio-single.html" class="loadcontent" rel="facilisi"><strong>Facilisi</strong></a></h5>
                        <span class="portfolio-categories">Web</span>
                    </div>
                </div>
            </div><!-- END #masonry -->	
